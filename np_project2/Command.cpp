...
void Command::set_user_pipe_in(int user_pipe_in)
{
    this->user_pipe_in = user_pipe_in;
}

void Command::set_user_pipe_out(int user_pipe_out)
{
    this->user_pipe_out = user_pipe_out;
}
...
bool Command::check_if_user_pipe_in()
{
    return (this->user_pipe_in) > 0;
}

bool Command::check_if_user_pipe_out()
{
    return (this->user_pipe_out) > 0;
}
...
int Command::get_user_pipe_in()
{
    return this->user_pipe_in;
}

int Command::get_user_pipe_out()
{
    return this->user_pipe_out;
}
...
void Command::info()
{
    ...
    cout << "User pipe in:" << user_pipe_in << endl;
    cout << "User pipe out:" << user_pipe_out << endl;
    cout << endl ;
}
